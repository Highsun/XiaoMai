...
![Framework](https://img.shields.io/badge/framework-Electron%20%7C%20Flask-brightgreen.svg)
![Language](https://img.shields.io/badge/language-JavaScript%20%7C%20Python-blue.svg)

![Platform](https://img.shields.io/badge/platform-desktop-yellow.svg)
...
The entire stack emphasizes **ease of deployment**, **development clarity**, and **team collaboration**, making XiaoMai an ideal learning foundation for teams exploring full-stack desktop app development.

> **Built with**: JavaScript (Electron) & Python (Flask)  
